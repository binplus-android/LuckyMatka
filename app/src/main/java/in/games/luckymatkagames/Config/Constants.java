package in.games.luckymatkagames.Config;

/**
 * Developed by Binplus Technologies pvt. ltd.  on 20,June,2020
 */
public class Constants {
    public static final String APP_NAME= "Kalyan21";
    public static int Matka_count=0;
    public static final String PREFS_NAME="Maplex Matka";
    public static final String IS_LOGIN="is_login";
    public static final String KEY_ID="id";
    public static final String KEY_NAME="name";
    public static final String KEY_USER_NAME="username";
    public static final String KEY_CODE="ref_code";
    public static final String KEY_SHARE_LINK="ref_share_link";
    ...
    public static final String KEY_WALLET_WINNING="wallet_winning";
    public static final String KEY_GENDER="gender";
    public static final String KEY_UPI="upi";
    public static final String KEY_DIALOG="dialog_status";
    public static final String KEY_GIF_IMAGE = "gif_image";
    public static final String KEY_MSG = "value";
    ...
    public static final int REQUEST_TIMEOUT = 8000000;
    public static final String  REQUEST_TIMEOUT_ERR = "Connection Timeout";
